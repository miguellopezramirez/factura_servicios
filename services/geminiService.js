...
async function generarResumenCompra(factura) {
  ...
  const prompt = `Redacta un mensaje amable y personalizado para un cliente que acaba de comprar lo siguiente: ${productos}, por un total de $${factura.total}. El cliente se llama ${factura.customer.name}.`;
